...
<div class="container mx-auto space-y-16 ">
    <section>
        <span class="block mb-2 text-xs font-medium tracki uppercase lg:text-center text-violet-600">How
            ...
            works</span>
        <h2
            class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500 lg:text-center text-gray-900">
            Building with Mamba is simple
        </h2>
        <div class="grid gap-6 my-16 lg:grid-cols-3">
            <div class="flex flex-col p-8 space-y-4 drop-shadow-xl rounded-md bg-gray-50">
                <div
            ...
            <div class="flex flex-col p-8 space-y-4 rounded-md drop-shadow-xl bg-gray-50">
                <div
                    class="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full bg-violet-600 text-gray-50">
                    2</div>
                <p class="text-2xl font-semibold">
            ...
            <div class="flex flex-col p-8 space-y-4 rounded-md drop-shadow-xl bg-gray-50">
                <div
                    ...
                    3</div>
                <p class="text-2xl font-semibold">
                    <b>Maxime.</b>Expedita temporibus culpa reprehenderit doloribus consectetur
                    odio!
                </p>
            </div>
        </div>
    </section>
    <section class="grid gap-6 drop-shadow-xl lg:grid-cols-2">
        <img src="https://source.unsplash.com/random/360x480" alt=""
            class="object-cover w-full rounded-md max-h-96  bg-gray-500">
        <div class="flex flex-col items-center w-full p-6 space-y-8 rounded-md lg:h-full lg:p-8 bg-gray-50">
            ...
            <div class="flex space-x-2">
                <button type="button" aria-label="Page 1" class="w-2 h-2 rounded-full bg-gray-900"></button>
                <button type="button" aria-label="Page 2" class="w-2 h-2 rounded-full bg-gray-400"></button>
                <button type="button" aria-label="Page 3" class="w-2 h-2 rounded-full bg-gray-400"></button>
                <button type="button" aria-label="Page 4" class="w-2 h-2 rounded-full bg-gray-400"></button>
            </div>
        </div>
        <div class="p-8 space-y-8 rounded-md drop-shadow-xl lg:col-span-full lg:py-12 bg-gray-50">
    ...
    <section>
        <div class="grid gap-6 drop-shadow-xl lg:grid-cols-3">
            <div class="overflow-hidden rounded lg:flex lg:col-span-3">
                ...
                <div class="p-6 space-y-6 lg:p-8 md:flex md:flex-col bg-gray-50">
                    <span class="self-start px-3 py-1 text-sm rounded-full bg-violet-600 text-gray-50">Business</span>
            ...
            <div class="p-6 rounded lg:p-8 drop-shadow-xl lg:py-12 bg-gray-50">
